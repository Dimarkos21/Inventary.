...
form.addEventListener("submit", async (e) => {
    ...
    try {
        ...
        setTimeout(async () => {
            ...
            const nuevoProducto = productos.find(producto => producto._id === data._id);
            if (nuevoProducto) {
...
document.addEventListener("DOMContentLoaded", () => {
    document.addEventListener("click", async (e) => {
        if (e.target && (e.target.id === "info" || e.target.closest("#info"))) {
            ...
            console.log(`ID del div seleccionado: ${padre.id}`);
            ...
            if (!padre.classList.contains("container-mas")) {
                ...
                if (productoSeleccionado) {
                    ...
                    padre.innerHTML = `
                        ...
                        <div id="descripcion">      
                            <p>Nombre:</p>
                            <input class="input-datos" value="${productoSeleccionado.nombre || 'Sin nombre'}" readonly></input>
                            <p>Cantidad:</p>
                            <input class="input-datos" value="${productoSeleccionado.cantidad || 0}" readonly></input>
                            <p>Costo:</p>
                            <input class="input-datos" value="${productoSeleccionado.costo || 0}" readonly></input>
                            <p>Precio:</p>
                            <input class="input-datos" value="${productoSeleccionado.precio || 0}" readonly></input>
                            <p>Fecha:</p>
                ...
                // Si ya tiene la clase container-mas, agregar más detalles o editar el contenido
